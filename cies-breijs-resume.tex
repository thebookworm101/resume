...
\maintitle{Mithrandir}{June 12, 1982}{Last update on \today}
...
\\
\\
At the age of seven (1989) Hannibal wrote his first lines of code in a \acr{LOGO}-like language on an \acr{MSX} (pre-\acr{PC}).  Two years later he attended a conference on an emerging new technology, the Internet, at the Erasmus University from which he would graduate 16 years later.

This is an empty line in a rather uneventful  place.
